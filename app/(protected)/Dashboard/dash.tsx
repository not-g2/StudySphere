...
const DeadlinesList = dynamicc(() => import("@/components/deadlines"), {
    ssr: false,
});
const AttendancePieChart = dynamicc(
    () => import("@/components/AttendancePieChart"),
    { ssr: false }
);
const GoalTable = dynamicc(() => import("@/components/goalview"), {
    ssr: false,
});
const FocusRadarChart = dynamicc(
    () => import("@/components/Dashboard/pomoradarchart"),
    { ssr: false }
);
const SubjectTimeBarChart = dynamicc(
    () => import("@/components/Dashboard/subjecttimechart"),
    { ssr: false }
);
const Leaderboard = dynamicc(() => import("@/components/leaderboard"), {
    ssr: false,
});
const LevelProgress = dynamicc(() => import("@/components/XPchart"), {
    ssr: false,
});
