...
const StudentList: React.FC = () => {
        ...
        const fetchSubmissions = async () => {
            try {
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_URL}/api/submissions/assignment/${assignmentId}/submissions`
                );
    ...
    const toggleApproval = async (submissionId: string) => {
        ...
        try {
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_URL}/api/submissions/submission/${submissionId}/feedback`,
                {
                    method: "PUT",
                    headers: {
