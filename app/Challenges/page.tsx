...
const ChallengePage: React.FC = () => {
    ...
    const [challenges, setChallenges] = useState<Challenge[]>([
        {
            ...
            description: "This is the first example challenge.",
            endDate: "2024-12-01",
        },
        {
            name: "Example Challenge 2",
            description: "This is the second example challenge.",
            endDate: "2024-12-15",
        },
    ]);
    ...
    return (
        <Box
            className="bg-c2 min-h-screen p-4"
            display="flex"
