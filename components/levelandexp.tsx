...
const LevelXPDisplay: React.FC<LevelXPDisplayProps> = ({ level, xp }) => {
  return (
    <div className="max-w-sm mx-auto text-center p-6 bg-black text-white border border-gray-700 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold">Level</h2>
      <p className="text-6xl font-extrabold text-blue-500">{level}</p>
