...
const SubjectSchedulerModal: React.FC<SubjectSchedulerModalProps> = ({
    onScheduleSubmit,
    onClose,
}) => {
            ...
            if (studentId) {
                try {
                    const response = await fetch(
                        `${process.env.NEXT_PUBLIC_URL}/api/courses/student/${studentId}`,
                        {
                            method: "GET",
                            headers: {
                    ...
                    const courseNames = data.coursesList.map(
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_URL}/api/tt/timetable`,
                {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${session?.user.token}`,
